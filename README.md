...
| 📚 课程 | **5 条赛道 54 课**：C# 基础 12 课（190 题）+ Unity 核心 12 课（210 题）+ 算法 10 专题（200 题）+ 游戏设计模式 10 课（80 题）+ **核心系统实战 10 课**（56 题：索敌/血量伤害/开火/子弹/背包/合成/商店/存档/波次生成），共 **736 题**；每个知识点附**「深入了解」详解**，全赛道覆盖 |
| 🧪 质量保障 | `node tools/verify-qs.mjs` 自动校验全题库：答案索引合法性、选项查重，**116 道"看代码猜输出"题用 JS 模拟器重算真实输出并与标定答案比对** |
